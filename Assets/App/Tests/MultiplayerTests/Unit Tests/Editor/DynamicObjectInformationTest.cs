...
namespace xyz._8bITProject.cooperace.multiplayer.tests
{
	...
	public class DynamicObjectInformationTest
	{
		...
		[Test]
		public void EqualsItselfShouldReturnFalse () {
			DynamicObjectInformation test = new DynamicObjectInformation (new Vector2 (), new Vector2 ());
		...
		public void EqualsDifferentPositionShouldReturnFalse () {
			...
			DynamicObjectInformation test1 = new DynamicObjectInformation (new Vector2 (1, 1), new Vector2 (0, 0));

			Assert.That (!test0.Equals (test1));
		}
		[Test]
		public void EqualsDifferentVelocityShouldReturnFalse () {
			DynamicObjectInformation test0 = new DynamicObjectInformation (new Vector2 (1, 1), new Vector2 (1, 1));
			DynamicObjectInformation test1 = new DynamicObjectInformation (new Vector2 (1, 1), new Vector2 (0, 0));
		...
		public void EqualsBothDifferentShouldReturnFalse () {
			DynamicObjectInformation test0 = new DynamicObjectInformation (new Vector2 (0, 0), new Vector2 (1, 1));
			DynamicObjectInformation test1 = new DynamicObjectInformation (new Vector2 (1, 1), new Vector2 (0, 0));
